...
//
//
//        User otherUser1 = User.builder().userName("fff").password("12345678").phone("911").build();
//
//        when(mockService.create(otherUser1)).thenThrow(new RuntimeException());
//
//        mockService.clearAdd(otherUser1);
//
//        // 查数据库，应该有2个用户
//        Assert.assertEquals(2, userService.getAllUsers().intValue());
//    }
...
//
//        User otherUser = User.builder().userName("xxx").password("12345678").phone("911").build();
//
//        userService.clearAdd(otherUser);
//
//    }
